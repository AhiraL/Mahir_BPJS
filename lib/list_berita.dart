...
class _ListBeritaState extends State<ListBerita> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: new Center(
            child: Text('Berita Terkini', style: TextStyle(color: Colors.black))),
  ...
  Future _getData() async {
    try {
      final response = await http.get(Uri.parse(
          "https://newsapi.org/v2/top-headlines?country=id&apiKey=7a4c98b8aa314979991d7bf0932c6eaf"));
